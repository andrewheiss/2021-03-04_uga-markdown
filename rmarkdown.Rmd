...
- [***R Markdown: The Definitive Guide***](https://bookdown.org/yihui/rmarkdown/). Look at the [PDF chapter](https://bookdown.org/yihui/rmarkdown/pdf-document.html) for details about fonts and figure sizing, etc. (and the [HTML chapter](https://bookdown.org/yihui/rmarkdown/html-document.html) for similar options when knitting to HTML, etc.)

- [***R Markdown Cookbook***](https://bookdown.org/yihui/rmarkdown-cookbook/). This has a bunch of extra tips and tricks, like [how to add a manual page break](https://bookdown.org/yihui/rmarkdown-cookbook/pagebreaks.html), [how to convert R models into math equations](https://bookdown.org/yihui/rmarkdown-cookbook/equatiomatic.html), [how to change font colors](https://bookdown.org/yihui/rmarkdown-cookbook/font-color.html), or [how to control the size of images](https://bookdown.org/yihui/rmarkdown-cookbook/figure-size.html)
...
```{r knit-button, indent="    ", fig.align="center", echo=FALSE, out.width="30%"}
knitr::include_graphics("img/knit-button.png", error = FALSE)
```
...
```{r insert-chunk, indent="    ", fig.align="center", echo=FALSE, out.width="30%"}
knitr::include_graphics("img/insert-chunk.png", error = FALSE)
```
...
```{r chunk-toc, echo=FALSE, out.width="40%", fig.align="center"}
knitr::include_graphics("img/chunk-toc.png", error = FALSE)
```
...
```{r chunk-options, echo=FALSE, out.width="70%", fig.align="center"}
knitr::include_graphics("img/chunk-options.png", error = FALSE)
```
...
```{r output-options, echo=FALSE, out.width="35%", fig.align="center"}
knitr::include_graphics("img/output-options.png", error = FALSE)
```
