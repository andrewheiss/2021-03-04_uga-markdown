---
title: "Universal documents and reproducible research"
author: "Andrew Heiss"
date: "`r Sys.Date()`"
output:
...
# Universal documents<br>and reproducibility
...
.box-4.huge[Academic writing is a<br>complicated, messy process!]
...
<figure>
  <img src="img/office-model.png" alt="The Office model" title="The Office model" width="100%">
</figure>
...
.center[
<figure>
  <img src="img/engineering-model.png" alt="The Engineering model" title="The Engineering model" width="50%">
</figure>

<figure>
  <img src="img/md-outputs.png" alt="Markdown outputs" title="Markdown outputs" width="100%">
</figure>
]
]
...
<figure>
  <img src="img/rr-abstract.png" alt="Reinhart and Rogoff abstract" title="Reinhart and Rogoff abstract" width="100%">
</figure>
...
<figure>
  <img src="img/path-to-prosperity.jpg" alt="The Path to Prosperity 2013 house budget" title="The Path to Prosperity 2013 house budget" width="65%">
...
<figure>
  <img src="img/thomas-herndon.jpg" alt="Thomas Herndon" title="Thomas Herndon" width="55%">
...
<figure>
  <img src="img/krugman-allowed.png" alt="Paul Krugman on Excel and reproducibility" title="Paul Krugman on Excel and reproducibility" width="100%">
...
.center[
<figure>
  <img src="img/rr-table1.png" alt="Reinhart Rogoff Table 1" title="Reinhart Rogoff Table 1" width="47%">
</figure>
]
...
.center.sp-after[
<figure>
  <img src="img/excel-numbers.png" alt="Numbers in Excel" title="Numbers in Excel" width="40%">
</figure>
]
...
<figure>
  <img src="img/airbnb.png" alt="Airbnb's data science tools" title="Airbnb's data science tools" width="100%">
...
<figure>
  <img src="img/uk-long.png" alt="UK Statistics pipeline" title="UK Statistics pipeline" width="100%">
</figure>

<figure>
  <img src="img/uk-short.png" alt="UK Statistics pipeline, short" title="UK Statistics pipeline, short" width="55%">
...
.center[
<figure>
  <img src="img/process-simple.png" alt="Simplified process" title="Simplified process" width="90%">
</figure>
]
...
.center[
<figure>
  <img src="img/process-rmd.png" alt="Rmd process" title="Rmd process" width="100%">
</figure>
]
...
.box-inv-4[You might know (or are learning) LaTeX]
...
.pull-right[
<figure>
  <img src="img/md-to-everything.png" alt="Markdown to everything" title="Markdown to everything" width="100%">
</figure>
]
...
.box-inv-4.medium[Makefiles]

--

.box-inv-4.medium[Bonus fun: R Markdown]

--

.box-inv-4[(Not today: Version control with git/GitHub)]
...
pagedown::chrome_print("universal-writing-reproducibility.html", 
                       output = "universal-writing-reproducibility.pdf")
```
